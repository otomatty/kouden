...
const faqs: FAQ[] = [
	...
	},
	{
		id: "faq-8",
		question:
			"Gmailを利用している場合は、メールアドレスとGoogleアカウントのどちらでもログインできますか？",
		answer:
			"はい、Gmailを利用している場合は、メールアドレスとGoogleアカウントのどちらでもログインできます。最初にメールアドレスでログインしてから、Googleアカウントでログインした場合でもアカウントは共通化されます。",
	},
];
