	...
	return (
		<div className="space-y-6">
			...
			<section aria-labelledby="summary-section-title">
				<h2 id="summary-section-title" className="sr-only">
					サマリー
				</h2>
			...
			<section aria-labelledby="metrics-section-title">
				<h2 id="metrics-section-title" className="text-xl font-semibold tracking-tight mb-4">
					ビジネス・運用指標
				</h2>
			...
			<section aria-labelledby="details-section-title">
				<h2 id="details-section-title" className="text-xl font-semibold tracking-tight mb-4">
					詳細情報
				</h2>
