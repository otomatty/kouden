...
interface DeliveryMethodToolbarProps {
	koudenId: string;
	onAdd?: () => void;
}
 ...
 * - 権限に応じてボタンの表示/非表示を制御
 */
export function DeliveryMethodToolbar({ koudenId, onAdd }: DeliveryMethodToolbarProps) {
...
// 型定義のエクスポート
export type { DeliveryMethodToolbarProps };
