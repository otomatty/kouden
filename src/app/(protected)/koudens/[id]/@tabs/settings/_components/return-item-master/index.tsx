...
import { ReturnItemMasterTable } from "./table/table";
...
interface ReturnItemMasterSectionProps {
	koudenId: string;
 ...
 * - 返礼品マスタの追加・編集・W削除
 */
export function ReturnItemMasterSection({
	koudenId,
	returnItemMasters = [],
}: ReturnItemMasterSectionProps) {
	// セクションの開閉状態
	...
	return (
		<div className="space-y-4">
			...
			{isOpen && (
				<div className="space-y-4">
					{isDesktop ? (
						<ReturnItemMasterTable koudenId={koudenId} returnItemMasters={returnItemMasters} />
					) : (
...
// 型定義のエクスポート
export type { ReturnItemMasterSectionProps };
