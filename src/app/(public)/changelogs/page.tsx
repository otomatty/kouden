...
export default async function ChangelogsPage() {
	...
	return (
		<>
			...
			<PageHero
				title="更新履歴"
				subtitle="香典帳アプリの最新アップデート情報をお届けします。新機能の追加、改善、バグ修正などの詳細をご確認いただけます。"
			/>
			<Container className="py-8 md:py-12">
				...
				{changelogs.length === 0 ? (
					...
					<>
						...
						{/* 最新バージョンのハイライト */}
						{changelogs.length > 0 && (
							<div className="mb-12 p-6 rounded-lg bg-background border-l-4 border-primary">
						...
						<div className="mt-12 p-6 rounded-lg bg-background border-l-4 border-primary">
							<h3 className="font-semibold mb-2">📝 バージョンの種類について</h3>
							<div className="text-sm text-muted-foreground space-y-2">
								<p>
									• <strong className="text-red-600">メジャー</strong>: 大幅な機能追加や破壊的変更
								</p>
								<p>
									• <strong className="text-blue-600">マイナー</strong>:
									新機能追加（後方互換性あり）
								</p>
								<p>
